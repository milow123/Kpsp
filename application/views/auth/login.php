                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('auth'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Password"> <?= form_error('password', '<p class="text-danger pl-3">', '</p>'); ?>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    <a href="<?= base_url('auth/regristrasi') ?>">Regristrasi</a>
                                </div>
                            </div>
                        </div>
                    </div>
