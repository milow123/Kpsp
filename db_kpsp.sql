...
--
-- Table structure for table `jawaban_kpsp`
--

CREATE TABLE `jawaban_kpsp` (
  `jawabankpsp_id` int(11) NOT NULL,
  `ujikpsp_id` int(11) NOT NULL,
  `kpsp_id` int(11) NOT NULL,
  `jawaban` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `jawaban_kpsp`
--

INSERT INTO `jawaban_kpsp` (`jawabankpsp_id`, `ujikpsp_id`, `kpsp_id`, `jawaban`) VALUES
(1, 2, 1, '1'),
(2, 2, 2, '1'),
(3, 2, 3, '1'),
(4, 2, 4, '1'),
...
(20, 'asd', 'asd', '2021-03-10', 'asd@mail.com', 'default.jpg', '$2y$10$AptklONtq/Lc7g4JINxRXekCl9JvwWatCXJtZAKF2YYVsgZgxHm/e', 2, 1, 1624688946),
(21, 'Udin', 'Udin Meong', '2021-01-01', 'udin@mail.com', 'default.jpg', '$2y$10$D0iFnxbGyUdWlKIKso/fOuNjjMm6cnw4YbQSR3zk7qaEPEsUF98NC', 2, 1, 1624763986);

-- --------------------------------------------------------

--
-- Table structure for table `uji_kpsp`
--

CREATE TABLE `uji_kpsp` (
  `ujikpsp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `uji_kpsp`
--

INSERT INTO `uji_kpsp` (`ujikpsp_id`, `tanggal_uji`, `user_id`, `umur`, `kategori`) VALUES
(1, '2021-06-26 14:55:48', 20, '3', 'sesuai'),
(2, '2021-06-26 14:56:19', 20, '3', 'sesuai'),
(3, '2021-06-26 14:56:27', 20, '3', 'sesuai'),
(4, '2021-06-26 15:17:12', 20, '18', 'sesuai'),
(5, '2021-06-26 15:26:17', 20, '3', 'meragukan');
...
--
-- Indexes for table `jawaban_kpsp`
--
ALTER TABLE `jawaban_kpsp`
  ADD PRIMARY KEY (`jawabankpsp_id`);
...
--
-- Indexes for table `uji_kpsp`
--
ALTER TABLE `uji_kpsp`
  ADD PRIMARY KEY (`ujikpsp_id`);
...
--
-- AUTO_INCREMENT for table `jawaban_kpsp`
--
ALTER TABLE `jawaban_kpsp`
  MODIFY `jawabankpsp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
-- AUTO_INCREMENT for table `uji_kpsp`
--
ALTER TABLE `uji_kpsp`
  MODIFY `ujikpsp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
